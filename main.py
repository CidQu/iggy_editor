def find_and_print_sequences(file_path):
    ...
    # We have two different character endings, if those are not exist that means our character list ended.
    ...
    with open(file_path, 'rb') as f:
        ...
        while True:
            ...
            try:
                ...
                while True:
                    char_position += 32
                    character = content[first_char_position + char_position : first_char_position + char_position + 16] # Skip 20 bytes after
